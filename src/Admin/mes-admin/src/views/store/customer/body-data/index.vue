  ...
  <div class="body-data">
    ...
    <div class="table-toolbar">
      <div class="toolbar-left">
        <span class="toolbar-hint">身体数据记录</span>
      </div>
...
import { getBodyDataRecords, createBodyDataRecord, getCustomerOptions } from '@/api/customer-profile'
import type { BodyDataRecord, BodyDataCreate, CustomerOption } from '@/api/customer-profile/types'
...
const bodyForm = reactive<BodyDataCreate>({
  customerId: 0,
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      await createBodyDataRecord({
        customerId: bodyForm.customerId,
