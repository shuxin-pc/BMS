        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceSubsystemCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TargetType = table.Column<int>(type: "integer", nullable: false),
                    TargetIds = table.Column<string>(type: "text", nullable: false),
                    TargetDesc = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ...
                    IsCrossTenant = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<int>(type: "integer", nullable: false, defaultValue: 100),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorTenantId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageRecipients_UserId_IsRead_IsDeleted_CreatedTime",
                schema: "bms_system",
                table: "MessageRecipients",
                columns: new[] { "UserId", "IsRead", "IsDeleted", "CreatedTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Messages_TenantId_CreatedTime",
                schema: "bms_system",
                table: "Messages",
