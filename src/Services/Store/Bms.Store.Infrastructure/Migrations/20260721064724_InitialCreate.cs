        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPointsThreshold = table.Column<decimal>(type: "numeric", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Remark = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertQuantity = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SampleGiftOuts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SampleGiftOuts_InventoryBatches_InventoryBatchId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SampleGiftOuts_Products_ProductId",
                        column: x => x.ProductId,
                        principalSchema: "bms_store",
                        principalTable: "Products",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_InventoryBatches_Tenant_BatchNo",
                schema: "bms_store",
                table: "InventoryBatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_TenantId_StoreId",
                schema: "bms_store",
                table: "ProductCategories",
                columns: new[] { "TenantId", "StoreId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SampleGiftOuts_InventoryBatchId",
                schema: "bms_store",
                table: "SampleGiftOuts",
                column: "InventoryBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_SampleGiftOuts_OutTime",
                schema: "bms_store",
                table: "SampleGiftOuts",
                column: "OutTime");

            migrationBuilder.CreateIndex(
                name: "IX_SampleGiftOuts_ProductId",
                schema: "bms_store",
                table: "SampleGiftOuts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SampleGiftOuts_TenantId_StoreId",
                schema: "bms_store",
                table: "SampleGiftOuts",
                columns: new[] { "TenantId", "StoreId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProducts_TenantId_StoreId",
                schema: "bms_store",
                table: "ServiceProducts",
                columns: new[] { "TenantId", "StoreId" });
